...
<description>Usar import.meta.env.VITE_API_KEY para compatibilidad con Vite y Netlify</description>
<content><![CDATA[import { GoogleGenAI } from "@google/genai";
import { FinancialData } from "../types";
// CORRECCIÓN FINAL: Usar import.meta.env.VITE_API_KEY (Estándar Vite/Netlify)
